    ...
    <div className="space-y-4 lg:space-y-6">
            ...
            <div className="flex-1 space-y-3 lg:space-y-4">
              <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
                <div className="flex-1">
                  ...
                  <p className="text-base lg:text-lg font-semibold text-blue-600 mb-1">{campaign.role}</p>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="px-2 lg:px-3 py-1 bg-blue-100 text-blue-600 rounded-full text-xs lg:text-sm font-medium">
                    {campaign.duration}
                  </span>
                </div>
              </div>
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-sm font-bold text-blue-600">{campaign.progress}%</span>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div 
                    className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 h-2 rounded-full transition-all duration-500"
              ...
              <div className="flex flex-wrap gap-2 lg:gap-3 pt-2">
                <button className="px-3 lg:px-4 py-2 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 text-white rounded-lg lg:rounded-xl hover:from-blue-700 hover:via-indigo-700 hover:to-purple-700 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg font-medium text-sm lg:text-base">
                  View Details
                </button>
                <button className="px-3 lg:px-4 py-2 bg-white border-2 border-blue-600 text-blue-600 rounded-lg lg:rounded-xl hover:bg-blue-50 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg font-medium text-sm lg:text-base">
                  Update Progress
                </button>
      ...
      {ongoingCampaigns.length === 0 && (
        <div className="text-center py-8 lg:py-12">
          ...
          <button className="px-4 lg:px-6 py-2 lg:py-3 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 text-white rounded-lg lg:rounded-xl hover:from-blue-700 hover:via-indigo-700 hover:to-purple-700 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg font-medium text-sm lg:text-base">
            Explore Campaigns
          </button>
        </div>
      )}
